...
def topup_workflow_wrapper(in_file, alt_file, alt_t, conf_file, pe_direction, te, epi_factor):
    ...
    tu_wf.inputspec.raw_file = in_file
...
def create_topup_all_workflow(session_info, name = 'topup_all' ):
    ...
    topup_workflow_wrapper_node = pe.MapNode(Function(input_names=
        ...
        output_names='outputspec.out_file',
    ...
    topup_all_workflow.connect(find_config_node, 'out_file', topup_workflow_wrapper_node, 'conf_file')
    ...
    # and the rest
    topup_all_workflow.connect(topup_workflow_wrapper_node, 'outputspec.out_file', datasink, 'tu')
